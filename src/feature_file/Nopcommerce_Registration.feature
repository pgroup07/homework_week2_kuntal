Feature: Nopcommerce Registration
  ...
  Background: I am on  Nopcommerce Registration page
    ...
    Then   I am open Nopcommerce Registration page

  Scenario Outline: I should not able to register with invalid data on mandatory field (*) of registration page
  ...
  Scenario: I should able to select any one radio button from Gender Label of your Personal Details section
  ...
  Scenario Outline: I should be able to select Day,Month and Year from drop down list of birth field
